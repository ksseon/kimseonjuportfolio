        ...
        <div className="hero__grid">
          ...
          <div className="hero__right">
            <p className="hero__desc">
              제 이름 선주 자체가 배의 주인이라는 의미가 있어서 저만의 브랜딩을
              만들기 좋은 키워드라고 생각했습니다. 그래서 포트폴리오 전체를
              '항해하는 프론트엔드 개발자'라는 컨셉으로 잡았습니다. 선주는 혼자
              앞서가는 사람이 아니라, 바람을 읽고 모두가 안전하게 나아가도록
              돛과 노를 함께 맞추는 조율자입니다. 이처럼 저도 팀원 및 동료들과
              협력하여 각자의 강점을 모아 하나의 큰 바다를 향해 나아가겠습니다.
              또한 끊임없이 밀려오는 파도 속에서도 도전을 두려워하지 않고,
              나침반이 올바른 길을 가르키듯 사용자를 위한 직관적이고 편리한
              여정을 설계하는 개발자가 되고자 합니다.
            </p>
          </div>
        </div>
      </div>
